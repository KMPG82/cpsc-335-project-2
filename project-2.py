...
schedule_in_min, daily_act_in_min=convertToMinutes(person1_Schedule, person1_DailyAct)
print('schedule in minutes: ', schedule_in_min)
print('daily act in min: ', daily_act_in_min)

schedule_in_min, daily_act_in_min=convertToMinutes(person2_Schedule, person2_DailyAct)
print('schedule in minutes: ', schedule_in_min)
print('daily act in min: ', daily_act_in_min)